...
#SBATCH --mem=2G ## memory to allocate for your job in MB
...
source /lustre1/home/mass/eskalon/miniconda/bin/activate gffread
#########################################

### Below you can enter your program job command ###

gffread Pastreoides_all_v1.gff -T -o Pastreoides_all_v1.gtf
