...
#SBATCH --ntasks=2 ## number of cpu's to allocate for a job
#SBATCH --ntasks-per-node=2 ## number of cpu's to allocate per each node
...
#########################################
source /lustre1/home/mass/eskalon/miniconda/bin/activate kraken
### Below you can enter your program job command ###

#for R1 in /lustre1/home/mass/eskalon/Porites/analysis/mapping/unaligned/*_Unmapped.out.mate1; do
#R2="${R1%_Unmapped.out.mate1}_Unmapped.out.mate2"
#R3="${R1%_Unmapped.out.mate1}_kraken.out"

#kraken2 --db /lustre1/home/mass/eskalon/kraken/database/core \
# --paired  --threads 16 \
#$R1 $R2 > $R3
...
ktImportTaxonomy -t 5 -m 3 -o krona.html ./kraken.res/*
